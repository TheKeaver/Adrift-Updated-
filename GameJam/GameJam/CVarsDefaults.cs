...
namespace GameJam
{
    static partial class CVars
    {
        private static void CreateDefaultCVars()
        {
            ...
            Create<bool>("debug_show_render_culling", true, CVarFlags.LIVE_RELOAD);
            ...
            Create<string>("font_msdf_hyperspace_texture_character_33", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-33", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_34", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-34", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_35", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-35", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_36", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-36", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_37", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-37", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_38", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-38", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_39", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-39", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_40", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-40", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_41", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-41", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_42", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-42", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_43", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-43", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_44", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-44", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_45", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-45", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_46", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-46", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_47", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-47", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_48", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-48", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_49", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-49", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_50", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-50", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_51", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-51", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_52", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-52", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_53", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-53", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_54", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-54", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_55", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-55", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_56", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-56", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_57", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-57", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_58", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-58", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_59", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-59", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_60", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-60", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_61", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-61", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_62", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-62", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_63", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-63", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_64", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-64", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_65", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-65", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_66", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-66", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_67", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-67", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_68", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-68", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_69", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-69", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_70", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-70", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_71", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-71", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_72", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-72", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_73", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-73", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_74", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-74", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_75", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-75", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_76", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-76", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_77", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-77", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_78", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-78", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_79", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-79", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_80", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-80", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_81", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-81", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_82", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-82", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_83", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-83", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_84", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-84", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_85", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-85", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_86", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-86", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_87", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-87", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_88", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-88", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_89", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-89", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_90", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-90", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_91", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-91", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_92", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-92", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_93", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-93", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_94", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-94", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_95", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-95", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_96", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-96", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_97", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-97", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_98", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-98", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_99", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-99", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_100", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-100", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_101", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-101", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_102", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-102", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_103", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-103", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_104", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-104", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_105", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-105", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_106", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-106", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_107", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-107", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_108", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-108", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_109", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-109", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_110", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-110", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_111", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-111", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_112", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-112", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_113", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-113", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_114", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-114", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_115", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-115", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_116", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-116", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_117", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-117", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_118", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-118", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_119", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-119", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_120", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-120", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_121", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-121", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_122", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-122", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_123", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-123", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_124", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-124", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_125", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-125", CVarFlags.PRESERVE);
            Create<string>("font_msdf_hyperspace_texture_character_126", "fonts/Hyperspace/Hyperspace_MSDF/Hyperspace-126", CVarFlags.PRESERVE);
