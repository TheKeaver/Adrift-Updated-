...
namespace GameJam
{
    static partial class CVars
    {
        private static void CreateDefaultCVars()
        {
            ...
            Create<int>("gravity_hole_enemy_lifespan", 5, CVarFlags.DEV_PRESERVE, "Lifespand of gravity holes in seconds.");
            ...
            Create<float>("player_trail_minimum_movement", 200, CVarFlags.DEV_PRESERVE, "Minimum movement speed the player needs to be traveling for the trail to appear.");
